...

{
  ...
  virtualisation.oci-containers.containers."portainer-portainer" = {
    image = "portainer/portainer-ce:2.21.2"; # TODO : (Auto)update portainer here
    volumes = [
  ...
  systemd.services."docker-portainer-portainer" = {
    ...
    after = [
      ...
      "docker-volume-portainer_data.service"
    ];
    requires = [
      "docker-network-portainer_default.service"
      "docker-volume-portainer_data.service"
  ...
  # Volumes
  systemd.services."docker-volume-portainer_data" = {
    path = [ pkgs.docker ];
    serviceConfig = {
      Type = "oneshot";
      RemainAfterExit = true;
    ...
    script = ''
      docker volume inspect portainer_data || docker volume create portainer_data
    '';
    partOf = [ "docker-compose-portainer-root.target" ];
    wantedBy = [ "docker-compose-portainer-root.target" ];
  };
